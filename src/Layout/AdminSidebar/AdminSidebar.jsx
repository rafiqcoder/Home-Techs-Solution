...
const AdminSidebar = () => {
    return (
      <div className="flex flex-col h-full p-3 dark:dark:bg-gray-900 dark:dark:text-gray-100">
        <div className="space-y-3">
          ...
          <div className="flex-1">
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              ...
              <li className="rounded-sm">
                <div className="dropdown dropdown-right ">
                  ...
                  >
                    ...
                    <label tabIndex={0} className="hidden sm:flex">
                      Products
                      <svg
                    ...
                    >
                      <li className="p-1 bg-base-200 my-1">
                        <Link to="/dashboard/allproducts">All Products</Link>
                      </li>
                      <li className="py-1 bg-base-200">
              ...
              <li className="rounded-sm dark:dark:bg-gray-800 dark:dark:text-gray-50">
                <a
                  href="/"
                  rel="noopener noreferrer"
                  className="flex items-center p-2 space-x-3 rounded-md"
